...
Partial Public NotInheritable Class Servicios
...
Partial Friend NotInheritable Class Globals
    ...
    Private Shared _Servicios As Servicios

    Friend Shared Property Servicios() As Servicios
        Get
            Return _Servicios
        End Get
        Set(value As Servicios)
            If (_Servicios Is Nothing) Then
                _Servicios = value
            Else
